...
class HashEncoder_two(nn.Module):
    def __init__(self, cfg_aabb_scale, n_pos_dims=3, n_features_per_level=2, n_levels=16, base_resolution=16, log2_hashmap_size=19):
        self.cfg = get_cfg()
        using_fp16 = self.cfg.fp16
        #aabb_scale = self.cfg.dataset_obj.aabb_scale
        aabb_scale = cfg_aabb_scale
