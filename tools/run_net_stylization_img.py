...
import numpy as np
import os
from jnerf.runner import Runner_two_img,NeuSRunner
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="./projects/ngp_stylization/ngp_pair_base_img.py",
        metavar="FILE",
