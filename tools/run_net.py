...
if __name__ == "__main__":
    ...
    #conf_list = ['hotdog','lego','ship','mic','materials','ficus','drums','chair']
    conf_list = ['llff_leaves','llff_orchids','llff_flower','llff_fortress']

    conf_list = ['llff_fern','llff_horns','llff_trex','llff_room']
    conf_list = ['llff_trex','llff_room']
    #conf_list = ['llff_Family','llff_Francis','llff_Horse','llff_Lighthouse','llff_M60','llff_Panther','llff_Playground','llff_Train',]
    #conf_list = ['llff_Family','llff_Francis','llff_Horse','llff_Lighthouse','llff_M60','llff_Panther','llff_Playground','llff_Train',]
    #conf_list = ['llff_fern']
    for cof in conf_list:
        cof_path = '/home/lishaoxu/JNeRF/projects/ngp_my/ngp_' + cof + '.py'
        main(cof_path)